        ...
        <header class="header">
            <div class="header_wrapper">
                <div class="header_upper">
                    <div class="header_upper_logo">
                    <a href="/bashelectrosbyt_project/"><img src="/bashelectrosbyt_project/assets/img/main_logo.png" alt="" class="header_upper_logo_img"></a>
                    </div>
                    <div class="header_upper_control">
                        <div class="header_upper_control_find">
                            <input type="text" placeholder="Поиск по сайту" class="header_upper_control_find_input">
                        </div>
                        <div class="header_upper_control_loweye">
                            <img src="/bashelectrosbyt_project/assets/img/svg/low_eye.svg" alt="" class="header_upper_control_loweye_img">
                        </div>
                    </div>
                </div>
                ...
                <nav class="header_downer_nav">
                    ...
                    <div class="subheader">
                            <div class="subheader_element"><a href="#" class="subheader_a">Результаты работы компании</a>
                        </div>
                            <div class="subheader_element subheader_element_wth_child">
                            <a href="#" class="subheader_a">Организационная структура</a>
                            <div class="sub_subheader">
                                    <div class="subheader_element"><a href="#" class="subheader_a">Результаты работы компании</a></div>
                                    <div class="subheader_element"><a href="#" class="subheader_a">Результаты работы компании</a></div>
                            </div>
                        </div>
